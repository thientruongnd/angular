...
declare namespace ts {
    const version: "2.1.0-dev.20160912";
...
declare namespace ts.FindAllReferences {
    ...
    function getReferencedSymbolsForNode(typeChecker: TypeChecker, cancellationToken: CancellationToken, node: Node, sourceFiles: SourceFile[], findInStrings: boolean, findInComments: boolean): ReferencedSymbol[];
